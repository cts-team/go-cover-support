...
import (
	"fmt"
	go_cover_support "github.com/cts-team/go-cover-support"
	"reflect"
)
...
func DifferentFields(dst, src, reference interface{}) ([]string, error) {
	...
	if len(differenceFields) != 0 {
		...
		differenceFields = go_cover_support.IntersectString(differenceFields, canUpdateFields)
	}
